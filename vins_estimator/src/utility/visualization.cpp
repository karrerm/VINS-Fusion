...
ros::Publisher pub_maplab_odometry;
...
void registerPub(ros::NodeHandle &n) {
  ...
  pub_maplab_odometry =
      n.advertise<maplab_msgs::OdometryWithImuBiases>("maplab_odometry", 1000);
...
void pubOdometry(const Estimator &estimator, const std_msgs::Header &header) {
  if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR) {
    ...
    // Publish the maplab odometry message
    maplab_msgs::OdometryWithImuBiases maplab_odom;
    maplab_odom.header = header;
    maplab_odom.header.frame_id = "world";
    maplab_odom.child_frame_id = "world";
    maplab_odom.pose.pose.position.x = estimator.Ps[WINDOW_SIZE].x();
    maplab_odom.pose.pose.position.y = estimator.Ps[WINDOW_SIZE].y();
    maplab_odom.pose.pose.position.z = estimator.Ps[WINDOW_SIZE].z();
    maplab_odom.pose.pose.orientation.x = tmp_Q.x();
    maplab_odom.pose.pose.orientation.y = tmp_Q.y();
    maplab_odom.pose.pose.orientation.z = tmp_Q.z();
    maplab_odom.pose.pose.orientation.w = tmp_Q.w();
    maplab_odom.twist.twist.linear.x = estimator.Vs[WINDOW_SIZE].x();
    maplab_odom.twist.twist.linear.y = estimator.Vs[WINDOW_SIZE].y();
    maplab_odom.twist.twist.linear.z = estimator.Vs[WINDOW_SIZE].z();
    maplab_odom.accel_bias.x = estimator.Bas[WINDOW_SIZE].x();
    maplab_odom.accel_bias.y = estimator.Bas[WINDOW_SIZE].y();
    maplab_odom.accel_bias.z = estimator.Bas[WINDOW_SIZE].z();
    maplab_odom.gyro_bias.x = estimator.Bgs[WINDOW_SIZE].x();
    maplab_odom.gyro_bias.y = estimator.Bgs[WINDOW_SIZE].y();
    maplab_odom.gyro_bias.z = estimator.Bgs[WINDOW_SIZE].z();
    pub_maplab_odometry.publish(maplab_odom);
